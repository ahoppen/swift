...
public:
  TokenSyntax(const RC<SyntaxData> &Data) : Syntax(Data) {}
...
public:
  TokenSyntaxRef(SyntaxDataRef *Data) : SyntaxRef(Data) {}
  
  TokenSyntaxRef(const TokenSyntax &Token) : SyntaxRef(Token.getDataPtr().get()) {}
